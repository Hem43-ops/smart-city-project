...
int status = true;
String alertMsg;
String mob1="+9779826454543";           // Enter first mobile number with country code
String mob2="+9779863480837"; // enter second number
 ...
 void SendMessage(String msg, String mob)
{
  ...
  mySerial.println("AT+CMGS=\"+9779826454543\""); 
  delay(1000);
